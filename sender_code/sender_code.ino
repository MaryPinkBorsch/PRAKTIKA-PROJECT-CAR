...
// F4:2D:C9:59:8D:AC for RECEIVER ----->  1C:C3:AB:F8:ED:08 new one receiver

//  for RECEIVER2
uint8_t receiverMac[] = {0x1C, 0xC3, 0xAB, 0xF8, 0xED, 0x08};
...
void joystickTask(void *pvParameters)
{
  while (1)
  {
    ...
    if ((joystickData.xValue < center - dead_zone || joystickData.xValue > center + dead_zone) || (joystickData.yValue < center - dead_zone || joystickData.yValue > center + dead_zone))
